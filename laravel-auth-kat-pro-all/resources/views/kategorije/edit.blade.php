    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('kategorije.update', $kategorija) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <select name="aktivna" id="aktivna"
                            ...
                            <option value="1" @selected(old('aktivna', (int)$kategorija->aktivna) == 1)>Da</option>
                            <option value="0" @selected(old('aktivna', (int)$kategorija->aktivna) == 0)>Ne</option>
                        </select>
